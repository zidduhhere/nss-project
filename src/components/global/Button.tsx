...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        const baseStyles = 'w-full font-medium focus:ring-2 focus:ring-nss-500 focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg transform hover:scale-[1.02] active:scale-[0.98]';
