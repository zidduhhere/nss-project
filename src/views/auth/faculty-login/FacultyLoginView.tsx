...
import FacultyLoginLeftSide from './FacultyLoginLeftSide';
import FacultyLoginRightSide from './FacultyLoginRightSide';

export default function FacultyLoginView() {
