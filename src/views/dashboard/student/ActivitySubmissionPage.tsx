  ...
  const tabs = [
    {
      ...
      icon: Droplets,
      color: "text-blood-800",
      bgColor: "bg-blood-50",
      gradientFrom: "from-blood-800",
      gradientTo: "to-blood-600",
      borderColor: "border-blood-900",
      hoverBg: "hover:bg-blood-50",
      description: "Submit your blood donation certificate",
      detailedDescription:
        "Save lives by donating blood and earn recognition for your contribution",
      requirements: [
    ...
    },
    {
      ...
      detailedDescription:
        "Contribute to environmental conservation through tree planting initiatives",
      requirements: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 sm:p-8">
              ...
              <div className={`flex items-center gap-3 mb-6 pb-6 border-b`}>
                <div
                  className={`p-3 rounded-xl bg-gradient-to-br ${activeTabData.gradientFrom} ${activeTabData.gradientTo}`}
                >
          ...
          <div className="space-y-6">
            ...
            {/* Impact Card */}
            <div
              className={`bg-gradient-to-br ${activeTabData.gradientFrom} ${activeTabData.gradientTo} rounded-2xl shadow-lg p-6 text-white`}
            >
              <div className="flex items-center gap-2 mb-4">
                {activeTab === "blood-donation" ? (
