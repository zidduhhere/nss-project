    ...
    <section className="relative overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
                <h1 className="text-4xl md:text-6xl font-thin tracking-tight text-secondary-900">Donate Blood. Sustain Life.</h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <a href="#importance" className="inline-flex items-center justify-center px-8 py-4 text-md font-medium text-secondary-700 border border-nss-300 hover:bg-nss-100 rounded-full transition">Why It Matters</a>
                </div>
