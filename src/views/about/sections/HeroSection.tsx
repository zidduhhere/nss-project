export const AboutHeroSection = () => (
    <section className="bg-white  mx-auto px-6 lg:px-12 pb-20">
        <div className="mx-auto max-w-7xl ">
            <div className="grid lg:grid-cols-2 gap-12 items-start ">
                <div className="space-y-8">
                    <h1 className="text-4xl md:text-6xl font-isans font-thin tracking-tight text-secondary-900">Empowering Social Impact</h1>
